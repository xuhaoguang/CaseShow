...
public:
 ...
 virtual ~SimCalc(){} 
    ...
    //return void
    //retval
    void get_freq_order_vector(std::string& str1, std::string& str2, std::vector<int>& join_str1_freq, std::vector<int>& join_str1_order, std::vector<int>& join_str2_freq, std::vector<int>& join_str2_order);
    ...
    float sim_order(std::vector<int> v1, std::vector<int> v2);
...
#endif //SICT_CASESHOW_SIM_CALC_H
