...
<main class="main">
    ...
    <?php
        ...
        $fenciRes =  httpPost("http://localhost/split.php", $params);
        //echo httpPost("http://localhost/split.php", $params);
    ?>
    <script type="text/javascript">
        function fun1(){
            document.getElementById("textarearesult").value="<?php echo $fenciRes; ?>";
        }
    </script>

    <div class="nlptool-result">
        <div class="nlptool-result-left">
            <div class="nlptool-select" onclick="fun1()">分词标注</div>
            <div class="nlptool-select" onclick="fun1()">词频统计</div>
            <div class="nlptool-select" onclick="fun1()">抽关键词</div>
            <div class="nlptool-select" onclick="fun1()">实体抽取</div>
            <div class="nlptool-select" onclick="fun1()">文本分类</div>
            <div class="nlptool-select" onclick="fun1()">自动文摘</div>
        </div>
        <div class="nlptool-result-center">
            <textarea class="result" id="textarearesult" placeholder="NLP处理结果展示" readonly="readonly"><?php echo "<font>" . $fenciRes . "</font>"; ?></textarea>
        </div>
